...
| [Mock Adapters](mock-adapters.md) | Rift (`managed`/`connect`), WireMock, and the **embedded FFM** provider (single `zio-bdd-rift` artifact, JDK 22+ runtime); the capability × adapter matrix; choosing one |
